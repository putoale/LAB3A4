...
################################################################
# This is a generated script based on design: bd_top_00
#
...
# source bd_top_00_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# debouncer, debouncer, depacketizer, edge_detector, edge_detector, moving_average, mute_v1, packetizer, volume_controller
...
proc create_root_design { parentCell } {
  ...
  set input_signal_0 [ create_bd_port -dir I input_signal_0 ]
  set input_signal_1 [ create_bd_port -dir I input_signal_1 ]
  ...
  connect_bd_intf_net -intf_net moving_average_0_m_axis [get_bd_intf_pins moving_average_0/m_axis] [get_bd_intf_pins mute_v1_0/s_axis]
  connect_bd_intf_net -intf_net mute_v1_0_m_axis [get_bd_intf_pins mute_v1_0/m_axis] [get_bd_intf_pins volume_controller_0/s_axis]
  ...
  connect_bd_net -net input_signal_0_1 [get_bd_ports input_signal_0] [get_bd_pins debouncer_0/input_signal]
  connect_bd_net -net input_signal_1_1 [get_bd_ports input_signal_1] [get_bd_pins debouncer_1/input_signal]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aresetn] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aresetn] [get_bd_pins depacketizer_0/aresetn] [get_bd_pins moving_average_0/aresetn] [get_bd_pins mute_v1_0/aresetn] [get_bd_pins packetizer_0/aresetn] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins volume_controller_0/aresetn]
