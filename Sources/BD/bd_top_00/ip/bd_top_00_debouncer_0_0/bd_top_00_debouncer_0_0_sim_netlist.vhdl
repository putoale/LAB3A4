...
-- Date        : Mon Jun  1 13:33:45 2020
-- Host        : DESKTOP-O39JAIK running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Vivado_DESD_Project/Project/Personal/Lab3_A4/LAB3A4/Sources/BD/bd_top_00/ip/bd_top_00_debouncer_0_0/bd_top_00_debouncer_0_0_sim_netlist.vhdl
-- Design      : bd_top_00_debouncer_0_0
...
entity bd_top_00_debouncer_0_0_debouncer is
  port (
  ...
  attribute ORIG_REF_NAME of bd_top_00_debouncer_0_0_debouncer : entity is "debouncer";
end bd_top_00_debouncer_0_0_debouncer;

architecture STRUCTURE of bd_top_00_debouncer_0_0_debouncer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_top_00_debouncer_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of bd_top_00_debouncer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_top_00_debouncer_0_0 : entity is "bd_top_00_debouncer_0_0,debouncer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of bd_top_00_debouncer_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of bd_top_00_debouncer_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of bd_top_00_debouncer_0_0 : entity is "debouncer,Vivado 2019.2";
end bd_top_00_debouncer_0_0;

architecture STRUCTURE of bd_top_00_debouncer_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET reset, FREQ_HZ 225000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of reset : signal is "xilinx.com:signal:reset:1.0 reset RST";
  attribute x_interface_parameter of reset : signal is "XIL_INTERFACENAME reset, POLARITY ACTIVE_HIGH, INSERT_VIP 0";
begin
U0: entity work.bd_top_00_debouncer_0_0_debouncer
     port map (
      clk => clk,
      debounced => debounced,
