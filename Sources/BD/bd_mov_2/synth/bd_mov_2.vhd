...
--Command     : generate_target bd_mov_2.bd
--Design      : bd_mov_2
...
entity bd_mov_2 is
  ...
  attribute CORE_GENERATION_INFO of bd_mov_2 : entity is "bd_mov_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_mov_2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=6,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_mov_2 : entity is "bd_mov_2.hwdef";
end bd_mov_2;

architecture STRUCTURE of bd_mov_2 is
  component bd_mov_2_AXI4Stream_UART_0_0 is
  port (
  ...
  end component bd_mov_2_AXI4Stream_UART_0_0;
  component bd_mov_2_depacketizer_0_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_mov_2_depacketizer_0_0;
  component bd_mov_2_packetizer_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_mov_2_packetizer_0_0;
  component bd_mov_2_clk_wiz_0_0 is
  port (
    reset : in STD_LOGIC;
  ...
  end component bd_mov_2_clk_wiz_0_0;
  component bd_mov_2_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    Res : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component bd_mov_2_util_vector_logic_0_0;
  component bd_mov_2_moving_average_v2_0_0 is
  port (
    clk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    sw_in : in STD_LOGIC;
  ...
  end component bd_mov_2_moving_average_v2_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of sys_clock : signal is "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN bd_mov_2_sys_clock, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
...
AXI4Stream_UART_0: component bd_mov_2_AXI4Stream_UART_0_0
     port map (
...
clk_wiz_0: component bd_mov_2_clk_wiz_0_0
     port map (
      clk_in1 => sys_clock_1,
...
depacketizer_0: component bd_mov_2_depacketizer_0_0
     port map (
...
moving_average_v2_0: component bd_mov_2_moving_average_v2_0_0
     port map (
      aresetn => util_vector_logic_0_Res(0),
...
packetizer_0: component bd_mov_2_packetizer_0_0
     port map (
      aclk => clk_wiz_0_clk_out2,
      aresetn => util_vector_logic_0_Res(0),
      ...
      s_axis_tdata(15 downto 0) => moving_average_v2_0_m_axis_TDATA(15 downto 0),
      s_axis_tlast => moving_average_v2_0_m_axis_TLAST,
      s_axis_tready => moving_average_v2_0_m_axis_TREADY,
      s_axis_tvalid => moving_average_v2_0_m_axis_TVALID
    );
util_vector_logic_0: component bd_mov_2_util_vector_logic_0_0
     port map (
      Op1(7) => reset_1,
      Op1(6) => reset_1,
      Op1(5) => reset_1,
