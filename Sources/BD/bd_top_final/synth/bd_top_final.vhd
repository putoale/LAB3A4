...
--Command     : generate_target bd_top_final.bd
--Design      : bd_top_final
...
entity bd_top_final is
  ...
  attribute CORE_GENERATION_INFO of bd_top_final : entity is "bd_top_final,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_top_final,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=11,numReposBlks=11,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=8,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_top_final : entity is "bd_top_final.hwdef";
end bd_top_final;

architecture STRUCTURE of bd_top_final is
  component bd_top_final_AXI4Stream_UART_0_0 is
  port (
  ...
  end component bd_top_final_AXI4Stream_UART_0_0;
  component bd_top_final_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    Res : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component bd_top_final_util_vector_logic_0_0;
  component bd_top_final_clk_wiz_0_0 is
  port (
    reset : in STD_LOGIC;
  ...
  end component bd_top_final_clk_wiz_0_0;
  component bd_top_final_debouncer_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  end component bd_top_final_debouncer_0_0;
  component bd_top_final_debouncer_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  end component bd_top_final_debouncer_1_0;
  component bd_top_final_edge_detector_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  end component bd_top_final_edge_detector_0_0;
  component bd_top_final_edge_detector_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  end component bd_top_final_edge_detector_1_0;
  component bd_top_final_moving_average_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_top_final_moving_average_0_0;
  component bd_top_final_packetizer_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_top_final_packetizer_0_0;
  component bd_top_final_depacketizer_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_top_final_depacketizer_0_0;
  component bd_top_final_mute_v1_0_0 is
  port (
    clk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  end component bd_top_final_mute_v1_0_0;
  ...
  signal NLW_edge_detector_0_edge_detected_UNCONNECTED : STD_LOGIC;
  signal NLW_edge_detector_1_edge_detected_UNCONNECTED : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of reset : signal is "xilinx.com:signal:reset:1.0 RST.RESET RST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of reset : signal is "XIL_INTERFACENAME RST.RESET, INSERT_VIP 0, POLARITY ACTIVE_HIGH";
  attribute X_INTERFACE_INFO of sys_clock : signal is "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK";
  attribute X_INTERFACE_PARAMETER of sys_clock : signal is "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN bd_top_final_sys_clock, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  input_signal_0_1 <= btnUp;
  input_signal_0_2 <= btnDown;
  mute_left_0_1 <= btnL;
  mute_right_0_1 <= btnR;
  reset_1 <= reset;
  sw_in_0_1 <= sw_in_0;
...
AXI4Stream_UART_0: component bd_top_final_AXI4Stream_UART_0_0
     port map (
...
clk_wiz_0: component bd_top_final_clk_wiz_0_0
     port map (
      clk_in1 => sys_clock_1,
...
debouncer_0: component bd_top_final_debouncer_0_0
     port map (
...
debouncer_1: component bd_top_final_debouncer_1_0
     port map (
      clk => clk_wiz_0_clk_out2,
...
depacketizer_0: component bd_top_final_depacketizer_0_0
     port map (
...
edge_detector_0: component bd_top_final_edge_detector_0_0
     port map (
      clk => clk_wiz_0_clk_out2,
      edge_detected => NLW_edge_detector_0_edge_detected_UNCONNECTED,
      input_signal => debouncer_0_debounced,
      reset => reset_1
    );
edge_detector_1: component bd_top_final_edge_detector_1_0
     port map (
      clk => clk_wiz_0_clk_out2,
      edge_detected => NLW_edge_detector_1_edge_detected_UNCONNECTED,
      input_signal => debouncer_1_debounced,
      reset => reset_1
    );
moving_average_0: component bd_top_final_moving_average_0_0
     port map (
      aresetn => util_vector_logic_0_Res(0),
      clk => clk_wiz_0_clk_out2,
...
mute_v1_0: component bd_top_final_mute_v1_0_0
     port map (
      aresetn => util_vector_logic_0_Res(0),
      clk => clk_wiz_0_clk_out2,
      ...
      s_mute_tdata(15 downto 0) => moving_average_0_m_axis_TDATA(15 downto 0),
      s_mute_tlast => moving_average_0_m_axis_TLAST,
      s_mute_tready => moving_average_0_m_axis_TREADY,
      s_mute_tvalid => moving_average_0_m_axis_TVALID
    );
packetizer_0: component bd_top_final_packetizer_0_0
     port map (
      aclk => clk_wiz_0_clk_out2,
      aresetn => util_vector_logic_0_Res(0),
...
util_vector_logic_0: component bd_top_final_util_vector_logic_0_0
     port map (
      Op1(7) => reset_1,
      Op1(6) => reset_1,
      Op1(5) => reset_1,
