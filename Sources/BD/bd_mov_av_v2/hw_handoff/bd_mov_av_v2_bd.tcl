...
# module references:
# depacketizer, moving_average_v2, packetizer
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net moving_average_v2_0_m_axis [get_bd_intf_pins moving_average_v2_0/m_axis] [get_bd_intf_pins packetizer_0/s_axis]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aclk] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins depacketizer_0/aclk] [get_bd_pins moving_average_v2_0/clk] [get_bd_pins packetizer_0/aclk]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aresetn] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aresetn] [get_bd_pins depacketizer_0/aresetn] [get_bd_pins moving_average_v2_0/aresetn] [get_bd_pins packetizer_0/aresetn] [get_bd_pins util_vector_logic_0/Res]
