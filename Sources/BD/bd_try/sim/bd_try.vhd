...
entity bd_try is
  ...
  attribute CORE_GENERATION_INFO of bd_try : entity is "bd_try,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_try,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=12,numReposBlks=12,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=9,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_try : entity is "bd_try.hwdef";
end bd_try;

architecture STRUCTURE of bd_try is
  component bd_try_AXI4Stream_UART_0_0 is
  port (
  ...
  end component bd_try_AXI4Stream_UART_0_0;
  component bd_try_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    Res : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component bd_try_util_vector_logic_0_0;
  component bd_try_clk_wiz_0_0 is
  port (
    reset : in STD_LOGIC;
  ...
  end component bd_try_clk_wiz_0_0;
  component bd_try_depacketizer_0_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_try_depacketizer_0_0;
  component bd_try_packetizer_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_try_packetizer_0_0;
  component bd_try_debouncer_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  end component bd_try_debouncer_0_0;
  component bd_try_debouncer_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  end component bd_try_debouncer_1_0;
  component bd_try_edge_detector_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  end component bd_try_edge_detector_0_0;
  component bd_try_edge_detector_1_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_signal : in STD_LOGIC;
  ...
  end component bd_try_mute_v1_0_0;
  component bd_try_volume_controller_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  signal mute_v1_0_m_axis_TDATA : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal mute_v1_0_m_axis_TLAST : STD_LOGIC;
  signal mute_v1_0_m_axis_TREADY : STD_LOGIC;
  signal mute_v1_0_m_axis_TVALID : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of sys_clock : signal is "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN bd_try_sys_clock, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
...
AXI4Stream_UART_0: component bd_try_AXI4Stream_UART_0_0
     port map (
...
clk_wiz_0: component bd_try_clk_wiz_0_0
     port map (
      clk_in1 => sys_clock_1,
...
debouncer_0: component bd_try_debouncer_0_0
     port map (
...
debouncer_1: component bd_try_debouncer_1_0
     port map (
      clk => clk_wiz_0_clk_out2,
...
depacketizer_0: component bd_try_depacketizer_0_0
     port map (
...
edge_detector_0: component bd_try_edge_detector_0_0
     port map (
      clk => clk_wiz_0_clk_out2,
...
edge_detector_1: component bd_try_edge_detector_1_0
     port map (
      clk => clk_wiz_0_clk_out2,
...
moving_average_0: component bd_try_moving_average_0_0
     port map (
      aresetn => util_vector_logic_0_Res(0),
      clk => clk_wiz_0_clk_out2,
...
mute_v1_0: component bd_try_mute_v1_0_0
     port map (
      aresetn => util_vector_logic_0_Res(0),
      clk => clk_wiz_0_clk_out2,
      m_axis_tdata(15 downto 0) => mute_v1_0_m_axis_TDATA(15 downto 0),
      m_axis_tlast => mute_v1_0_m_axis_TLAST,
      m_axis_tready => mute_v1_0_m_axis_TREADY,
      m_axis_tvalid => mute_v1_0_m_axis_TVALID,
...
packetizer_0: component bd_try_packetizer_0_0
     port map (
      aclk => clk_wiz_0_clk_out2,
      aresetn => util_vector_logic_0_Res(0),
...
util_vector_logic_0: component bd_try_util_vector_logic_0_0
     port map (
      Op1(7) => reset_1,
      Op1(6) => reset_1,
      Op1(5) => reset_1,
...
volume_controller_0: component bd_try_volume_controller_0_0
     port map (
      aclk => clk_wiz_0_clk_out2,
      aresetn => util_vector_logic_0_Res(0),
      ...
      s_axis_tdata(15 downto 0) => mute_v1_0_m_axis_TDATA(15 downto 0),
      s_axis_tlast => mute_v1_0_m_axis_TLAST,
      s_axis_tready => mute_v1_0_m_axis_TREADY,
      s_axis_tvalid => mute_v1_0_m_axis_TVALID,
